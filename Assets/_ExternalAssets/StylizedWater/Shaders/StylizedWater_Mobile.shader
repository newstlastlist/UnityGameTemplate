...
Shader "StylizedWater/Mobile"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			o.vertexToFrag715 = lerp(( -20.0 * v.texcoord.xy ),( (ase_worldPos).xz * float2( 0.1,0.1 ) ),1);
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float2 Tiling22 = i.vertexToFrag715;
			float2 temp_output_24_0 = ( Tiling22 * _Rimtiling );
			...
			float2 temp_output_705_0 = ( _NormalTiling * Tiling22 );
			...
			float2 HeightmapUV581 = ( ( ( Tiling22 * _WaveSize ) * float2( 0.1,0.1 ) ) + ( WaveSpeed40 * float2( 0.5,0.5 ) ) );		
			float2 HeightmapUV582 = ( ( ( Tiling21 * _WaveSize ) * float2( 0.1,0.1 ) ) + ( WaveSpeed40 * float2( 0.5,0.5 ) ) );		
					
			float t = saturate(InverseLerp(_ColorStart , _ColorEnd , HeightmapUV582.y));		
						
			//_Color = lerp(fixed4(1,1,1,1), _Color, mainTex.a);		
			_WaterColor = lerp(_ColorA, _ColorB, t);		
			...
			float4 tex2DNode67 = tex2D( _Shadermap, ( ( _FoamTiling * Tiling22 ) + temp_output_634_0 + ( Heightmap99 * 0.1 ) ) );
			#ifdef _USEINTERSECTIONFOAM_ON
				float staticSwitch725 = ( 1.0 - tex2DNode67.b );
			#else
				float staticSwitch725 = saturate( ( 1000.0 * ( ( tex2D( _Shadermap, ( ( _FoamTiling * ( Tiling22 * float2( 0.5,0.5 ) ) ) + temp_output_634_0 ) ).r - tex2DNode67.r ) - _FoamSize ) ) );
			#endif
